<template>
  <div>
    <div class="w-full">
      <a-row justify="space-between" align="center" wrap class="bg-transparent pr-5 py-3 text-white">
        <a-col :xs="24" :sm="24" :md="24" :lg="10" :xl="6" :xxl="6">
          <router-link to="/" class="flex flex-row items-end app-logo ml-5 pb-2">
            <img src="./full_logo.png" alt="NFT Marketplace" width="120" height="120" class="inline-block -mt-2" />
            <div class="inline-block font-bold text-xl ml-2">
              NFT Marketplace
            </div>
          </router-link>
        </a-col>
        <a-col class="flex flex-row items-center justify-evenly" :xs="24" :sm="24" :md="24" :lg="14" :xl="10" :xxl="6">
          ...
          <div class="flex justify-end items-end">
            <a-button type="primary" @click="connectWebsite" size="large">
